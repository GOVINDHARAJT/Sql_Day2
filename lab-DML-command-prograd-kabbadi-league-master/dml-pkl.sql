...
VALUES(6,'ajay thakur','Balwan Singh',1,1);

INSERT INTO team
(id,name,coach,home_city,captain)
VALUES(7,'srikant','Babu',2,1);
...
VALUES(7,'ajay thakur','india',5,6);

--8. Insert into venue
insert into venue values(2,'Chennai',1);
...
UPDATE player SET name='Ajay' WHERE ID=7;
SELECT * FROM player;
...
UPDATE player SET country='india' WHERE name='Ajay';
SELECT * FROM PLAYER;
